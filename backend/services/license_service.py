...
# NOC-Monitoring-Pro: selalu identifikasi diri sebagai 'monitoring_pro' ke license server
# agar divalidasi dengan kunci ArBa-MP-XXXX-XXXX
    ...
    try:
        async with httpx.AsyncClient(timeout=10.0) as client:
            ...
            if res.status_code == 200:
                ...
                if EDITION == "monitoring_pro" and returned_edition != "monitoring_pro":
                    # Monitoring Pro — hanya menerima kunci ArBa-MP-XXXX-XXXX
                    ...
                    await db.system_settings.update_one(
                        ...
                        {"$set": {
                            "status": "invalid",
                            "message": (
                                f"Lisensi '{key[:12]}...' bukan lisensi NOC-Monitoring-Pro. "
                                f"Gunakan lisensi Monitoring Pro (ArBa-MP-XXXX-XXXX)."
                            ),
                            "hardware_id": hw_id,
                            "updated_at": now_str,
                        }},
